# Layer 14 display module: sway-on-DRM with Mesa graphics.
#
# SM8550 Tier B confirmed:
...
#
# The display stack itself is shared; per-device output and touch routing live
# under rocknix.device.display.swayDeviceConfig.
#
